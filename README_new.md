...
**Configure Training**:
- Ensure the dataset is extracted into `BE/basketball-detection-srfkd-1` or `BE/datasetname` 
- Check `train_model.py` config class (the script is tailored for my hardware: GTX 1060 6GB - i7 6700k - 16gb ram):

```python
DATASET_DIR = Path("basketball-detection-srfkd-1") # As a default
EPOCHS = 200
